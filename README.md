...
<br />在这行代码里面，完成了所有的bean的初始化与依赖注入的问题。结果你在这行代码的后面，才将mybatis产生的代理对象加入到spring容器，那么其他依赖这些代理对象的bean还依赖个鸟啊，所以你这样写根本没有什么卵用。<br />
